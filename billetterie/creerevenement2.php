				...
				<br>
				 <form role="form"><center>
				  <div class="form-group">
					  <label for="usr">Prix de la place cotisant BDE</label><br>
					  <input type="text" class="form-control" id="usr">
				  </div>
				  <br>
				  <div class="form-group">
					  <label for="usr">Prix de la place non cotisant BDE</label><br>
					  <input type="text" class="form-control" id="usr">
				  </div>
				  <br>
				  <div class="form-group">
					  <label for="usr">Prix de la place extérieure</label><br>
					  <input type="text" class="form-control" id="usr">
				  </div>
				  <br>
				  <a href="creerevenement3.php" class="btn btn-primary" role="button">Suite -></a>
				 </center>
				</form>
			</div>
